...
class Anggota extends CI_Controller {
	...
	public function ubah($id)
	{
		...
		$data['data'] = $this->anggota_model->detail_data($where, 'perpusweb_anggota')->result();
	...
	public function detail_data($id)
  {
	...
	public function proses_hapus($id)
	{
		...
		if($foto){
			...
			$this->anggota_model->hapus_data($where, 'perpusweb_anggota');
		}
	...
	public function proses_tambah()
	{
		...
		$data=array(
		  ...
		  $this->anggota_model->tambah_data($data, 'perpusweb_anggota');
		  $this->session->set_flashdata('Pesan','
			<script>
			$(document).ready(function() {
			swal.fire({
	...
	public function proses_ubah()
	{
		...
		$where = array('id_anggota'=>$kode);
		  ...
		  $this->anggota_model->ubah_data($where, $data, 'perpusweb_anggota');
		  $this->session->set_flashdata('Pesan','
			<script>
			$(document).ready(function() {
			swal.fire({
